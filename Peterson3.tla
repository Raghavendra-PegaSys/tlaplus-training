...
LEMMA LQ2b == <<Next /\ proc(1)>>_vars /\ (Q /\ pc[1] = "cs") => (Q /\ pc[1] = "a2" )'
        BY DEF Inv, TypeOK, I, Not, vars, proc, a2, a3_cs, a3_a3, cs, Q        
    
LEMMA LQ2a == [Next]_vars /\ (Q /\ pc[1] = "cs") => (Q /\ pc[1] = "cs")' \/ (Q /\ pc[1] = "a2")'
    <1>1 vars' = vars /\ (Q /\ pc[1] = "cs") => (Q /\ pc[1] = "cs")'
        BY DEF Inv, TypeOK, I, Not, vars, Q
    <1>2 proc(0) /\ (Q /\ pc[1] = "cs") => (Q /\ pc[1] = "cs")'
        BY DEF Inv, TypeOK, I, Not, vars, proc, a2, a3_cs, a3_a3, cs, Q        
    <1>6 QED
        BY LQ2b, <1>1, <1>2 DEF Next

LEMMA LQ2c == (Q /\ pc[1] = "cs") => ENABLED <<proc(1)>>_vars
    PROOF OMITTED
    
    
LEMMA LQ2 == [][Next]_vars /\ WF_vars(proc(0)) /\ WF_vars(proc(1)) => 
    (Q /\ pc[1] = "cs") ~> (Q /\ pc[1] = "a2" )
    BY LQ2a, LQ2b, LQ2c, PTL DEF Next
    
LEMMA LQ3b == <<Next /\ proc(1)>>_vars /\ (Q /\ pc[1] = "a3") => (Q /\ pc[1] = "cs" )'
        BY DEF Inv, TypeOK, I, Not, vars, proc, a2, a3_cs, a3_a3, cs, Q        
    
LEMMA LQ3a == [Next]_vars /\ (Q /\ pc[1] = "a3") => (Q /\ pc[1] = "a3")' \/ (Q /\ pc[1] = "cs")'
    <1>1 vars' = vars /\ (Q /\ pc[1] = "a3") => (Q /\ pc[1] = "a3")'
        BY DEF Inv, TypeOK, I, Not, vars, Q
    <1>2 proc(0) /\ (Q /\ pc[1] = "a3") => (Q /\ pc[1] = "a3")'
        BY DEF Inv, TypeOK, I, Not, vars, proc, a2, a3_cs, a3_a3, cs, Q        
    <1>6 QED
        BY LQ3b, <1>1, <1>2 DEF Next

LEMMA LQ3c == (Q /\ pc[1] = "a3") => ENABLED <<proc(1)>>_vars
    PROOF OMITTED
    
LEMMA LQ3 == [][Next]_vars /\ WF_vars(proc(0)) /\ WF_vars(proc(1)) => 
    (Q /\ pc[1] = "a3") ~> (Q /\ pc[1] = "cs" )
    BY LQ3a, LQ3b, LQ3c, PTL DEF Next
...
\* Last modified Thu Oct 01 23:37:53 AEST 2020 by raghavendra
